  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <p className="text-orange-600 font-bold animate-bounce">Carregando todos os pedidos...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 font-sans">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Todos os Pedidos</h1>
        {orders.length > 0 ? (
